                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b text-center">
                            <div class="inline-flex space-x-2">
                                <a href="/editkeanggotaan/{{$row->id}}" type=button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-full">Edit</a>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = `/delete/keanggotaan/${id}`;
                }
            });
        }
    </script>
