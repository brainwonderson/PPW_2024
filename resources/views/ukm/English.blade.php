...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="bg-yellow-100 p-8 rounded-md text-center animate__animated animate__fadeIn">
            <h1 class="text-3xl font-bold mb-4">English Club (EC)</h1>
            <p class="text-gray-700 mb-4">Unit kegiatan mahasiswa yang bertujuan meningkatkan kemampuan bahasa Inggris melalui berbagai aktivitas seperti percakapan, debat, dan presentasi.</p>
